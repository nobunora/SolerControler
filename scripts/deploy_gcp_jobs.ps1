...
$commonEnv = @(
    ...
    "SOC_EXPORT_CONTRACT_STATUS=inactive",
    ...
    "SOC_MONTHLY_TIER_LANDING_ENABLED=false",
    "SOC_MONTHLY_TIER_CLOSE_DAY=14",
    "SOC_TIER1_UNDERUSE_PENALTY_YEN_PER_KWH=0",
    "SOC_TIER1_CROSSING_PENALTY_YEN_PER_KWH=0",
    "SOC_TIER2_EXTRA_PENALTY_YEN_PER_KWH=0",
    "SOC_TIER3_EXTRA_PENALTY_YEN_PER_KWH=0",
