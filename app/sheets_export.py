...
DATA_DESCRIPTION_ROWS: list[dict[str, str]] = [
    ...
    {
        "sheet": "sunshine_daily",
        "column": "forecast_pv_total_kwh",
        "description": "3面合算の予測発電量",
        "unit": "kWh/day",
        "source": "PV array GTI model",
        "notes": "東・南・西アレイのhourly GTI発電予測を合算した値です。",
    },
    {
        "sheet": "sunshine_daily",
        "column": "forecast_pv_morning_kwh",
        "description": "朝の予測発電量",
        "unit": "kWh",
        "source": "PV array GTI model",
        "notes": "07:00-10:00の3面合算予測です。",
    },
    {
        "sheet": "sunshine_daily",
        "column": "forecast_pv_midday_kwh",
        "description": "昼の予測発電量",
        "unit": "kWh",
        "source": "PV array GTI model",
        "notes": "10:00-16:00の3面合算予測です。",
    },
    {
        "sheet": "sunshine_daily",
        "column": "forecast_pv_evening_kwh",
        "description": "夕方の予測発電量",
        "unit": "kWh",
        "source": "PV array GTI model",
        "notes": "16:00-23:00の3面合算予測です。",
    },
    {
        "sheet": "sunshine_daily",
        "column": "forecast_pv_calibration_factor",
        "description": "発電予測の実績補正係数",
        "unit": "ratio",
        "source": "PV array calibration",
        "notes": "過去実績発電量とGTIモデル予測の比から推定した係数です。",
    },
    {
        "sheet": "sunshine_daily",
        "column": "source",
    ...
    },
    {
        ...
        "unit": "percent",
        "source": "Battery operation pipeline",
        "notes": "その日にPV発電中の充電が最後に発生した時点の蓄電池残量です。",
    },
    {
        "sheet": "battery_daily_metrics",
        "column": "pv_charge_end_at",
        "description": "太陽光充電終了時刻",
        "unit": "local timestamp",
        "source": "Battery operation pipeline",
        "notes": "pv_charge_end_soc_percent を採用した監視サンプルの時刻です。",
    },
    {
        "sheet": "battery_daily_metrics",
        "column": "updated_at",
...
def run_export(*, slot: str) -> int:
    ...
    specs: list[tuple[str, str, list[str]]] = [
        ...
        ("battery_daily_metrics", "battery_daily_metrics", ["date", "setting_soc_target_percent", "night_charge_kwh", "pv_max_charge_kwh", "pv_charge_end_soc_percent", "pv_charge_end_at", "updated_at"]),
