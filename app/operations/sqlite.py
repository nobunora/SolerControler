...
# readable-code-audit: skip STRUCT-04 — forecast and actual rows are written in one SQLite transaction so a run cannot leave a mixed snapshot
            ...
            detail.update(
                {
                    ...
                    "planned_charge_start_time": night_plan.get("planned_charge_start_time"),
                    "planned_charge_end_time": night_plan.get("planned_charge_end_time"),
                    "applied_charge_start_time": night_plan.get("applied_charge_start_time"),
                    "applied_charge_end_time": night_plan.get("applied_charge_end_time"),
